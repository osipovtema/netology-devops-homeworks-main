...
resource "yandex_storage_bucket" "encrypted" {
  ...
  acl        = var.encrypted_bucket_params.bucket_acl
...
resource "yandex_storage_object" "site-encrypted" {
...
resource "yandex_storage_bucket" "site" {
  ...
  access_key = yandex_iam_service_account_static_access_key.storage-sa.access_key
  secret_key = yandex_iam_service_account_static_access_key.storage-sa.secret_key
  bucket     = var.site_bucket_params.bucket_name
  acl        = var.site_bucket_params.bucket_acl
  https {
